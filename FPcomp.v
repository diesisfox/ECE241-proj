...
//altfp_compare CBX_AUTO_BLACKBOX="ALL" DEVICE_FAMILY="Cyclone V" PIPELINE=1 WIDTH_EXP=8 WIDTH_MAN=23 aeb agb ageb alb aleb aneb clock dataa datab unordered
...
module  FPcomp_altfp_compare_dtd
	( 
	aeb,
	agb,
	ageb,
...
endmodule //FPcomp_altfp_compare_dtd
//VALID FILE
...
module FPcomp (
	...
	wire  aleb = sub_wire4;
	wire  aneb = sub_wire5;
	wire  unordered = sub_wire6;

	FPcomp_altfp_compare_dtd	FPcomp_altfp_compare_dtd_component (
				.clock (clock),
				.dataa (dataa),
				.datab (datab),
				.aeb (sub_wire0),
...
// Retrieval info: GEN_FILE: TYPE_NORMAL FPcomp_bb.v FALSE
