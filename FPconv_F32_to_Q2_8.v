...
// ============================================================
// File Name: FPconv_F32_to_Q2_8.v
// Megafunction Name(s):
// 			ALTFP_CONVERT
//
...
//altfp_convert CBX_AUTO_BLACKBOX="ALL" DEVICE_FAMILY="Cyclone V" OPERATION="FLOAT2FIXED" ROUNDING="TO_NEAREST" WIDTH_DATA=32 WIDTH_EXP_INPUT=8 WIDTH_EXP_OUTPUT=8 WIDTH_INT=2 WIDTH_MAN_INPUT=23 WIDTH_MAN_OUTPUT=23 WIDTH_RESULT=10 clock dataa result
...
//altbarrel_shift CBX_AUTO_BLACKBOX="ALL" DEVICE_FAMILY="Cyclone V" PIPELINE=2 SHIFTDIR="VARIABLE" SHIFTTYPE="LOGICAL" WIDTH=32 WIDTHDIST=5 aclr clk_en clock data direction distance result
...
module  FPconv_F32_to_Q2_8_altbarrel_shift_b4h
	( 
	aclr,
	clk_en,
	clock,
...
endmodule //FPconv_F32_to_Q2_8_altbarrel_shift_b4h

//synthesis_resources = lpm_add_sub 6 lpm_compare 4 reg 190 
//synopsys translate_off
`timescale 1 ps / 1 ps
//synopsys translate_on
module  FPconv_F32_to_Q2_8_altfp_convert_lum
	( 
	clock,
	dataa,
	result) ;
	...
	wire  [31:0]   wire_altbarrel_shift2_result;
	...
	wire  [8:0]   wire_add_1_adder_result;
	wire  [4:0]   wire_add_sub1_result;
	wire  wire_add_sub3_cout;
	wire  [3:0]   wire_add_sub3_result;
	wire  [4:0]   wire_add_sub4_result;
	...
	FPconv_F32_to_Q2_8_altbarrel_shift_b4h   altbarrel_shift2
	( 
	.aclr(aclr),
	.clk_en(clk_en),
	.clock(clock),
	...
	assign
		...
		inv_add_1_adder2_w = (({5{(~ wire_add_sub3_cout)}} & inv_integer[8:4]) | ({5{wire_add_sub3_cout}} & wire_add_sub4_result)),
...
endmodule //FPconv_F32_to_Q2_8_altfp_convert_lum
//VALID FILE
...
module FPconv_F32_to_Q2_8 (
	...
	FPconv_F32_to_Q2_8_altfp_convert_lum	FPconv_F32_to_Q2_8_altfp_convert_lum_component (
				.clock (clock),
				.dataa (dataa),
				.result (sub_wire0));
...
// Retrieval info: GEN_FILE: TYPE_NORMAL FPconv_F32_to_Q2_8.v TRUE FALSE
// Retrieval info: GEN_FILE: TYPE_NORMAL FPconv_F32_to_Q2_8.qip TRUE FALSE
// Retrieval info: GEN_FILE: TYPE_NORMAL FPconv_F32_to_Q2_8.bsf FALSE TRUE
// Retrieval info: GEN_FILE: TYPE_NORMAL FPconv_F32_to_Q2_8_inst.v FALSE TRUE
// Retrieval info: GEN_FILE: TYPE_NORMAL FPconv_F32_to_Q2_8_bb.v FALSE TRUE
// Retrieval info: GEN_FILE: TYPE_NORMAL FPconv_F32_to_Q2_8.inc FALSE TRUE
// Retrieval info: GEN_FILE: TYPE_NORMAL FPconv_F32_to_Q2_8.cmp FALSE TRUE
